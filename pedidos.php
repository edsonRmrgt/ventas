  ...
  <div class="row">
    <div class="col-md-2 col-lg-2" align="left">
      <div class="list-group">
        <a href="clientes.php" class="list-group-item"></label>CLIENTES</label></a>
        <a href="productos.php" class="list-group-item"></label>PRODUCTOS</label></a>
        <a href="venta.php" class="list-group-item"></label>REGISTRAR VENTA</label></a>
        <a href="reportes.php" class="list-group-item"></label>REPORTES</label></a>
        <a href="#" class="list-group-item active"></label>PEDIDOS</label></a>
      </div>
    </div> 
    <div class="col-md-10">
     <h1>Nuevo Pedido</h1>
